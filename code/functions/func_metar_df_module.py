...
def metar_processing():
    ...
    df = pd.read_json('D:\Data Scientist\MBA\TCC\\repo\\related_archives\\response.json')
    # transforma e exporta o dataframe em csv 
    df.to_csv('D:\Data Scientist\MBA\TCC\\repo\\related_archives\metar.csv', index=False)

    all_metars = '\n'.join(line.split(',')[2] for line in open('D:\Data Scientist\MBA\TCC\\repo\\related_archives\metar.csv', 'rt'))
